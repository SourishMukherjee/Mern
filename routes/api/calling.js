...
exports.add=function(req,resp,reqbody){
  try{
    ...
    if(data){
        var sql="INSERT INTO UserAccess_Header(Trans_Type,Location,Reason,Emp_ID,Emp_Name,Emp_Designation,Emp_Department,Emp_Email,DOJ,Employee_Type,Software,Trans_Datetime,UserAccess_Headerkey) VALUES";
        sql+= util.format("('%s','%s','%s','%d','%s','%s','%s','%s','%s','%s','%s','%s','%d')",data.Trans_Type,data.Location,data.Reason,data.Emp_ID,data.Emp_Name,data.Emp_Designation,data.Emp_Department,data.Emp_Email,data.DOJ,data.Employee_Type,data.Software,data.Trans_Datetime,data.UserAccess_Headerkey);
